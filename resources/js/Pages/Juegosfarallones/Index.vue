        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                <ul class="list-reset lg:flex justify-end flex-1 items-center">
                    ...
                    <li class="mr-3">
                        <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Info</a>
                    </li>
                    <li class="mr-3">
                        <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Historia</a>
                    </li>
                    <li class="mr-3">
                        <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Gallería</a>
                    </li>
                </ul>
                <button
    ...
    <footer class="bg-white">
        <div class="container mx-auto px-8">
            <div class="w-full flex flex-col md:flex-row py-6">
                ...
                <div class="flex-1">
                    ...
                    <ul class="list-reset mb-6">
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Inicio</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Galería</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Historia</a>
                        </li>
                    </ul>
                </div>
                <div class="flex-1">
                ...
                <div class="flex-1">
                    <p class="uppercase text-gray-500 md:mb-6">Institucional</p>
                    <ul class="list-reset mb-6">
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Acerda de</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Información</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Contáctanos</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400" v-if="isOpen">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block md:w-8/12 align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                    ...
                    <form-wizard next-button-text="Siguiente" subtitle="Formulario de registro" color="#009db0"
                    ...
                    >
                        <tab-content title="Datos personales" icon="ti-ticket" :before-change="validateDatospersonales">
                            ...
                            <section>
                                ...
                                <div class="mt-2 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Departamento de nacimiento</label>
                                        <div class="mt-1">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Ciudad de nacimiento</label>
                                        <div class="mt-1">
                                ...
                                <div class="mt-2 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Número de años viviendo en Cali</label>
                                        <div class="mt-1">
                                ...
                                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        <span v-if="true" class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                        ...
                        <tab-content title="Nominaciones" icon="ti-user" :before-change="validateCheckout">
                            ...
                            <section>
                                ...
                                <div v-show="estado == 'selctPeriodo'" class="mt-2 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Nombre competición</label>
                                        <div class="mt-1">
                                    ...
                                    <div>
                                        <label :class="{'font-bold' : estado == 4}" class="block mt-2 text-sm font-medium text-gray-700">Certificado</label>
                                        <div class="my-auto">
                                ...
                                <div v-show="estado == 'selctPeriodo'" class="mt-2 grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-4">
                                    ...
                                    <div>
                                        <label :class="{'font-bold' : estado == 4}" class="block mt-2 text-sm text-bold font-medium text-gray-700">Plata</label>
                                        <div class="mt-1 flex">
                                    ...
                                    <div>
                                        <label :class="{'font-bold' : estado == 4}" class="block mt-2 text-sm text-bold font-medium text-gray-700">Bronce</label>
                                        <div class="mt-1 flex">
                                        ...
                                        <div class="lg:px-4 md:px-2 sm:px-0 py-2 overflow-y-auto h-50">
                                            <table class="border-black text-black table-fixed w-full">
                                                ...
                                                <tr class="text-black text-center" @click="rowSelect(dato.id)" text-sm v-if="form.nominaciones" v-for="(dato, id) in form.nominaciones" :key="dato.id">
                                                    ...
                                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.oro"></td>
                                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.plata"></td>
                                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.bronce"></td>
                                                </tr>
                                                <tr v-else>
                        ...
                        <tab-content title="Contacto" icon="ti-basketball" :before-change="validateContacto">
                            ...
                            <section>
                                ...
                                <div class="mt-2 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700">Corre electrónico</label>
                                        <div class="mt-1">
                                ...
                                <div v-show="form.acudiente">
                                    ...
                                    <div class="mt-2 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                        <div>
                                            <label class="text-black block text-sm font-medium text-gray-700">Nombre</label>
                                            <div class="mt-1">
