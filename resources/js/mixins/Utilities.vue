...
export default {
    ...
    methods: {
        ...
        buscarDocumento: function (documento) {
            axios.get('/nominado',{
                params: {
                    documento: documento
                }
            }).then((res) => {
                if (res.data.nominado) {
                    if (res.data.nominado.id > 0) {
                        Swal.fire({
                            icon: 'success',
                        ...
                        this.form = res.data.nominado;
                        this.getCiudades(this.form.iddepartamento);
                    }
                }
            })
        },
        ...
        getModalidades: function () {
            axios.get('/modalidades',).then((res) => {
                this.arrayModalidades = res.data.modalidades;
            })
        },
        ...
        getCategorias: function (idmodalidad) {
