                        ...
                        <div class="lg:px-4 md:px-2 sm:px-0 py-2 pb-6">
                            <table class="table-fixed w-full">
                                ...
                                <tr class="bg-gray-100">
                                    ...
                                    <th class="px-4 py-2 w-7/12 text-sm font-bold hover:bg-blue-500 hover:text-gray-50 rounded-b">
                                        Mensaje
                                    </th>
                                ...
                                <tr class="text-center" text-sm v-if="arrayData.data" v-for="(dato, id) in arrayData.data" :key="id">
                                    ...
                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.mensaje"></td>
                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.archivo"></td>
